...
8. **Options** (Dynamic fields, conditional)\n   - **For Multiple Choice**: Four option input fields (Option1, Option 2, Option 3, Option 4) displayed simultaneously
   ...
   - **For Short Answer and Essay**: Options field is hidden\n9. **Correct Answer** (Text input, dropdown, or multi-select, required)
...
- **Question Bank Interface**: \n  - **View Toggle Control**: Toggle button or tab control at top of page to switch between Row View and Card View\n  - **Row View**: Compact table layout with sortable columns and Edit/Delete actions, with color-coded badges for all question types (including **Match the Following - Teal, Multiple Response MCQ - Indigo**)
