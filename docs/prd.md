...
- Click on question text to expand full question
...
\n**Card Header**:
- Question Type badge (color-coded: Multiple Choice - Blue, True/False - Green, Short Answer - Orange, Essay - Purple)
...
- **Options** (for Multiple Choice and True/False):
  - All options listed with option labels (A, B, C, D)
  - Correct answer highlighted with checkmark icon and green background
...
- Options displayed for Multiple Choice and True/False types
...
- **Question Bank**: Access to create questions for assigned subjects and lessons with dual view options
