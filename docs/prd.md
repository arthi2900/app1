...
- Form fields same as creation form (including image upload section with local file selection)
- **Image Editing**:
...
- Questions are automatically filtered by teacher's assigned subjects\n- Edit functionality available in both Row View and Card View (including image editing with local file selection)
...
- **Question Bank Management**:
  ...
  - Switch between Row View and Card View
  - Edit questions in both views (including image editing with local file selection)\n  - Access analytics dashboard\n  - **Support for all question types**: Multiple Choice, True/False, Short Answer, Essay, Match the Following, Multiple Response MCQ
